        ...
        for section_num in range(0, n_section):
            ...
            if signal_amplitude[peak_frequency_index] > self.threshold:
                self.ax1.text(section_num * self.sample_per_section, 0,
                              frequency_to_note(frequency[peak_frequency_index]),
            ...
            self.ax1.text(section_num * self.sample_per_section, 0.5 * max_y,
                          round(signal_amplitude[peak_frequency_index]),
